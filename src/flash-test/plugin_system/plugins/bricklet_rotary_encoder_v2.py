...
bricklet_rotary_encoder_v2.py: Rotary Encoder 2.0 plugin
...
class Plugin(CoMCUBrickletBase):
    TODO_TEXT = u"""\
1. Verbinde Rotary Encoder Bricklet 2.0 mit Port C
2. Drücke "Flashen"
...
"""
    ...
    def flash_clicked(self):
        self.flash_bricklet(get_bricklet_firmware_filename('rotary_encoder_v2'))
