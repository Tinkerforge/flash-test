...
bricklet_gps_v3.py: GPS 3.0 plugin
...
class Plugin(CoMCUBrickletBase):
    TODO_TEXT = u"""\
1. Verbinde GPS 3.0 Bricklet mit Port D des Master Bricks 3.0
2. Drücke "Flashen"
...
"""
    ...
    def get_device_identifier(self):
        return BrickletGPSV3.DEVICE_IDENTIFIER

    def flash_clicked(self):
        self.flash_bricklet(get_bricklet_firmware_filename(BrickletGPSV3.DEVICE_URL_PART))

    def new_enum(self, device_information):
        CoMCUBrickletBase.new_enum(self, device_information)

        self.gps = BrickletGPSV3(device_information.uid, self.get_ipcon())
        if self.gps.get_bootloader_mode() != BrickletGPSV3.BOOTLOADER_MODE_FIRMWARE:
            return
