...
bricklet_industrial_dual_analog_in_v2.py: Industrial Dual Analog In 2.0 plugin
...
class Plugin(CoMCUBrickletBase):
    TODO_TEXT = u"""\
1. Verbinde Industrial Dual Analog In Bricklet 2.0 mit Port D des Master Bricks 3.0
2. Drücke "Flashen"
