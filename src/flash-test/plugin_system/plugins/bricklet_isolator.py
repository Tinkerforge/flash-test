...
class Plugin(CoMCUBrickletBase):
    TODO_TEXT = u"""\
1. Verbinde Isolator Bricklet mit Port D des Master Bricks 3.0
2. Drücke "Flashen"
...
"""
    ...
    def flash_clicked(self):
        self.flash_bricklet(get_bricklet_firmware_filename(BrickletIsolator.DEVICE_URL_PART), power_off_duration=0.75)
