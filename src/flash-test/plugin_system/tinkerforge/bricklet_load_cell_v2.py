...
class BrickletLoadCellV2(Device):
    ...
    def set_weight_callback_configuration(self, period, value_has_to_change, option, min, max):
        ...
        self.ipcon.send_request(self, BrickletLoadCellV2.FUNCTION_SET_WEIGHT_CALLBACK_CONFIGURATION, (period, value_has_to_change, option, min, max), 'I ! c H H', '')
    ...
    def get_weight_callback_configuration(self):
        ...
        """
        return GetWeightCallbackConfiguration(*self.ipcon.send_request(self, BrickletLoadCellV2.FUNCTION_GET_WEIGHT_CALLBACK_CONFIGURATION, (), '', 'I ! c H H'))
