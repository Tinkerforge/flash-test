# -*- coding: utf-8 -*-
#############################################################
# This file was automatically generated on 2018-06-12.      #
#                                                           #
...
try:
    from .bricklet_ac_current import BrickletACCurrent
except ValueError:
    from bricklet_ac_current import BrickletACCurrent
...
try:
    from .bricklet_moisture_v2 import BrickletMoistureV2
except ValueError:
    from bricklet_moisture_v2 import BrickletMoistureV2
...
try:
    from .bricklet_ozone import BrickletOzone
except ValueError:
    from bricklet_ozone import BrickletOzone
