...
ReaderGetPageLowLevel = namedtuple('ReaderGetPageLowLevel', ['data_length', 'data_chunk_offset', 'data_chunk_data'])
...
class BrickletNFC(Device):
    ...
    FUNCTION_READER_GET_PAGE_LOW_LEVEL = 9
    ...
    def __init__(self, uid, ipcon):
        ...
        self.response_expected[BrickletNFC.FUNCTION_READER_GET_PAGE_LOW_LEVEL] = BrickletNFC.RESPONSE_EXPECTED_ALWAYS_TRUE
    ...
    def reader_get_page_low_level(self):
        """
        TODO
        """
        return ReaderGetPageLowLevel(*self.ipcon.send_request(self, BrickletNFC.FUNCTION_READER_GET_PAGE_LOW_LEVEL, (), '', 'H H 60B'))
    ...
    def reader_get_page(self):
        """
        TODO
        """
        with self.stream_lock:
            ret = self.reader_get_page_low_level()
