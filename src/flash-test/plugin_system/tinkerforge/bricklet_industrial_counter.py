...
GetCounterConfiguration = namedtuple('CounterConfiguration', ['count_edge', 'count_direction', 'duty_cylce_prescaler', 'frequency_integration_time'])
...
class BrickletIndustrialCounter(Device):
    ...
    CALLBACK_ALL_COUNTER = 17
    CALLBACK_ALL_SIGNAL_DATA = 18
    ...
    def set_counter_configuration(self, pin, count_edge, count_direction, duty_cylce_prescaler, frequency_integration_time):
        """
        ...
        duty_cylce_prescaler = int(duty_cylce_prescaler)
        frequency_integration_time = int(frequency_integration_time)

        self.ipcon.send_request(self, BrickletIndustrialCounter.FUNCTION_SET_COUNTER_CONFIGURATION, (pin, count_edge, count_direction, duty_cylce_prescaler, frequency_integration_time), 'B B B B B', '')
