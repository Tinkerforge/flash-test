...
class BrickletRotaryEncoderV2(Device):
    ...
    def set_count_callback_configuration(self, period, value_has_to_change, option, min, max):
        ...
        self.ipcon.send_request(self, BrickletRotaryEncoderV2.FUNCTION_SET_COUNT_CALLBACK_CONFIGURATION, (period, value_has_to_change, option, min, max), 'I ! c H H', '')
    ...
    def get_count_callback_configuration(self):
        ...
        """
        return GetCountCallbackConfiguration(*self.ipcon.send_request(self, BrickletRotaryEncoderV2.FUNCTION_GET_COUNT_CALLBACK_CONFIGURATION, (), '', 'I ! c H H'))
