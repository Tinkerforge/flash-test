# -*- coding: utf-8 -*-
#############################################################
# This file was automatically generated on 2015-02-25.      #
#                                                           #
...
class BrickletAnalogIn2(Device):
    ...
    def __init__(self, uid, ipcon):
        ...
        self.response_expected[BrickletAnalogIn2.FUNCTION_SET_RANGE] = BrickletAnalogIn2.RESPONSE_EXPECTED_FALSE
        self.response_expected[BrickletAnalogIn2.FUNCTION_GET_RANGE] = BrickletAnalogIn2.RESPONSE_EXPECTED_ALWAYS_TRUE
    ...
    def set_range(self, range):
        ...
        * 5: 0V - 3.3V, ~0.81mV resolution, new in version 2.0.3 (Plugin)
        ...
        """
        self.ipcon.send_request(self, BrickletAnalogIn2.FUNCTION_SET_RANGE, (range,), 'B', '')
    ...
    def get_range(self):
        ...
        .. versionadded:: 2.0.1~(Plugin)
        """
        return self.ipcon.send_request(self, BrickletAnalogIn2.FUNCTION_GET_RANGE, (), '', 'B')
